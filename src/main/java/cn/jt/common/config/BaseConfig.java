package cn.jt.common.config;


import cn.jt.common.converter.*;
import cn.jt.common.enumerate.EnumDeserializer;
import cn.jt.utils.DateUtils;
import cn.jt.utils.id.CodeGenerate;
import cn.jt.utils.SpringIOCUtils;
...
public abstract class BaseConfig {
     ...
     */
    @Bean
    public SpringIOCUtils getSpringUtils(ApplicationContext applicationContext) {
        SpringIOCUtils.setApplicationContext(applicationContext);
