...
//        g2.setColor(Color.GRAY);
        g2.setColor(new Color(40, 140, 255));
        g2.fillRect(0, 0, w, h);

//        Color c = getRandColor(200, 250);//设置随机颜色
        Color c = new Color(40, 140, 255);//自定义颜色
        // 设置背景色
        g2.setColor(c);
...
//        g2.setColor(new Color(255, 255, 255)); //自定义颜色
//        for (int i = 0; i < 20; i++) {
...
//        g2.setColor(getRandColor(100, 160));
        g2.setColor(new Color(255, 255, 255));//设置文字颜色
        int fontSize = h - 8;
