...
public class Generator {
    // 表名,多个表使用英文逗号分割
    private static final String[] TBL_NAMES = {"wyy_cus"};

    // 表名的前缀,从表生成代码时会去掉前缀
    private static final String TABLE_PREFIX = "wyy_";
    // 数据库连接字段配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/dbcm?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8&useSSl=true";
    ...
    // 包名和模块名
    private static final String PACKAGE_NAME = "/com/wyy";
    ...
    private static final String XML_PATH = "/resources/com/wyy/";
    ...
    public static void main(String[] args) {
        ...
        fastAutoGenerator.strategyConfig(
                strategyConfigBuilder -> strategyConfigBuilder.entityBuilder()
                        ...
                        .idType(IdType.ASSIGN_ID)    // 全局主键类型为AUTO(自增)
...
//                        .disableSerialVersionUID()  // 禁用生成 serialVersionUID,默认值:true
                        ...
                        .superClass(Entity.class) //父实体类,并且可以继承lombok注解
        );
        ...
        fastAutoGenerator.strategyConfig(
                strategyConfigBuilder -> strategyConfigBuilder.controllerBuilder()
                        ...
                        .superClass(BaseController.class) //设置 Controller 类的父类
        );
